...
type MessageSend struct {
	...
	Embeds       []MessageSendEmbed       `json:"embeds,omitempty"`
	Masquerade   *MessageSendMasquerade   `json:"masquerade,omitempty"`
	Interactions *MessageSendInteractions `json:"interactions,omitempty"`
}

type MessageSendMasquerade struct {
	Name   string `json:"name,omitempty"`
	Avatar string `json:"avatar,omitempty"`
	Colour string `json:"colour,omitempty"`
}

type MessageSendInteractions struct {
	Reactions         []string `json:"reactions"`
	RestrictReactions bool     `json:"restrict_reactions"`
}

type MessageSendEmbed struct {
...
// Set content.
func (sms *MessageSend) SetContent(content string) *MessageSend {
	sms.Content = content
	return sms
}

// Set and format content.
func (sms *MessageSend) SetContentf(format string, values ...interface{}) *MessageSend {
	sms.Content = fmt.Sprintf(format, values...)
	return sms
}

// Add a new attachment.
func (sms *MessageSend) AddAttachment(attachment string) *MessageSend {
	sms.Attachments = append(sms.Attachments, attachment)
	return sms
}

// Add a new reply.
func (sms *MessageSend) AddReply(id string, mention bool) *MessageSend {
...
func (sms *MessageSend) CreateNonce() *MessageSend {
	sms.Nonce = ULID()
	return sms
}
